  ...
  <!-- /header -->
    ...
    <div class="container">
		<div class="forum-headline forum-panel">
			<h5 class="float-left"><?= ucwords($data['category_name']); ?> <span><?= ucwords($data['category_description']); ?></span></h5>
				...
				<div class="widget">
					...
					<div class="forum-sidebar-content">
						<ul>
							...
							<li <?php if($data['category_id'] == $categories[$count]['category_id']) echo "class='active'"; ?>><a href="<?= $https . '/forum/c/' . $categories[$count]['category_id'] . '/' . $categories[$count]['category_url_title']; ?>"><i class="fa fa-comments" style="padding-right: 5px;"></i><?= ucfirst($categories[$count]['category_name']); ?></a></li>
							<?php $count++;
							endforeach; ?>
						</ul>
					</div>
								...
								<div class="forum-content">
									...
									<div class="forum-content-subtitle">
										...
										<div class="forum-content-subtitle-postblock">
											<span>Posted By</span> 
											<a href="<?= $https . '/user/profile'; ?>"><?= ucfirst($thread[$count]['thread_author']['user_username']); ?></a>
											<a href="#"><?= $thread[$count]['adjusted_time']; ?></a>
										</div>
									</div>
								</div>
							</div>
