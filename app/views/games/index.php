...
<body class="fixed-header">
  ...
  <section class="bg-inverse p-y-0">
    <div class="owl-carousel owl-slide full-height">
      <div class="carousel-item" style="background-image: url('<?= $images . '/carousel/carousel-1.jpg'; ?>');">
      ...
      <div class="carousel-item" style="background-image: url('<?= $images . '/carousel/carousel-2.jpg'; ?>');">
        <div class="carousel-overlay"></div>
        <div class="carousel-caption">
          <div>
      ...
      <div class="row">
        <div class="col-12 col-sm-6 col-md-4">
          <div class="card card-lg">
            <div class="card-img">
              <a href="game-post.html"><img src="<?= $images . '/game/game-1.jpg'; ?>" class="card-img-top" alt="Assassin's Creed Syndicate"></a>
        ...
        <div class="col-12 col-sm-6 col-md-4">
          <div class="card card-lg">
            <div class="card-img">
              <a href="game-post.html"><img src="<?= $images . '/game/game-2.jpg'; ?>" class="card-img-top" alt="Rise of the Tomb Raider"></a>
        ...
        <div class="col-12 col-sm-6 col-md-4">
          <div class="card card-lg">
            <div class="card-img">
              <a href="game-post.html"><img src="<?= $images . '/game/game-3.jpg'; ?>" class="card-img-top" alt="The Witcher 3: Wild Hunt"></a>
        ...
        <div class="col-12 col-sm-6 col-md-4">
          <div class="card card-lg">
            <div class="card-img">
              <a href="game-post.html"><img src="<?= $images . '/game/game-4.jpg'; ?>" class="card-img-top" alt="Grand Theft Auto V"></a>
        ...
        <div class="col-12 col-sm-6 col-md-4">
          <div class="card card-lg">
            <div class="card-img">
              <a href="game-post.html"><img src="<?= $images . '/game/game-5.jpg'; ?>" class="card-img-top" alt="Deadpool The Game"></a>
              <div class="badge badge-ps4">Ps4</div>
              <div class="card-likes">
                <a href="#">36</a>
              </div>
        ...
        <div class="col-12 col-sm-6 col-md-4">
          <div class="card card-lg">
            <div class="card-img">
              <a href="game-post.html"><img src="<?= $images . '/game/game-6.jpg'; ?>" class="card-img-top" alt="Grand Theft Auto Online"></a>
              <div class="badge badge-xbox-one">Xbox One</div>
              <div class="card-likes">
                <a href="#">73</a>
              </div>
  ...
  <section class="bg-secondary no-border-bottom p-y-80">
    <div class="container">
      ...
      <div class="owl-carousel owl-list">
        ...
        <div class="card card-review">
          <a class="card-img" href="review-post.html">
          <img src="<?= $images . '/review/review-4.jpg'; ?>" alt="">
        ...
        <div class="card card-review">
          <a class="card-img" href="review-post.html">
          <img src="<?= $images . '/review/review-5.jpg'; ?>" alt="">
        ...
        <div class="card card-review">
          <a class="card-img" href="review-post.html">
          <img src="<?= $images . '/review/review-6.jpg'; ?>" alt="">
        ...
        <div class="card card-review">
          <a class="card-img" href="review-post.html">
          <img src="<?= $images . '/review/review-7.jpg'; ?>" alt="">
