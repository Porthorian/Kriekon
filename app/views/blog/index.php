			...
			<div class="col-lg-8">
			  ...
			  <div class="post">
				<div class="post-header">
				  <div>
					<a href="profile.html">
					<img src="<?= $images . '/user/user-5.jpg'; ?>" alt="">
				  </a>
				  </div>
				  <div>
					<h2 class="post-title">
			...
			<div class="col-lg-4">
			  <div class="sidebar">
				...
				<div class="widget widget-newsletter">
				  <div class="widget-block" style="background-image: url('<?= $images . '/widget/widget-newsletter.jpg'; ?>')">
					<div class="overlay"></div>
					<form>
					  <p>Get notification when new games are available on Kriekon.</p>
					  <div class="form-group input-icon-right">
				  ...
				  <div class="tab-content">
					<div role="tabpanel" class="tab-pane active" id="comments">
					  <ul class="widget-comments">
						<li>
						  <div><a href="profile.html"><img src="<?= $images . '/user/user-2.jpg'; ?>" alt=""></a></div>
						  <div>
							<a href="blog-post.html#comments"><b>Elizabeth:</b> It would have taken a ridiculous amount of careful precise actions.</a>
						  </div>
						</li>
						<li>
						  <div><a href="profile.html"><img src="<?= $images . '/user/user-3.jpg'; ?>" alt=""></a></div>
						  <div>
						...
						<li>
						  <div><a href="profile.html"><img src="<?= $images . '/user/user-1.jpg'; ?>" alt=""></a></div>
						  <div>
						...
						<li>
						  <div><a href="profile.html"><img src="<?= $images . '/user/user-5.jpg'; ?>" alt=""></a></div>
						  <div>
