	...
	<section class="breadcrumbs">
		<div class="container">
			<ol class="secondary-nav">
				<li class="active"><a href="#">TOP</a><i class="fa fa-question-circle secondary-nav-icon"></i></li>
				<li><a href="<?= $https . '/social/followed'; ?>">FOLLOWED</a><i class="fa fa-question-circle secondary-nav-icon"></i></li>
		  ...
		  <div class="twPc-div">
				...
				<div>
					<a title="<?= $data[0]['user_view']['user_username']; ?>" href="<?= $https . '/user/p/' . strtolower($data[0]['user_view']['user_username']); ?>" class="twPc-avatarLink">
						<img alt="<?= $data[0]['user_view']['user_username']; ?>" src="https://pbs.twimg.com/profile_images/653321214316818432/r4cMHUbx_bigger.jpg" class="twPc-avatarImg">
					</a>
