  ...
  <section class="hero hero-profile" style="background-image: url('https://img.youtube.com/vi/D3pYbbA1kfk/maxresdefault.jpg');">
    ...
    <div class="container">
      <div class="hero-block">
        <h5><?= $data['user']['user_username']; ?></h5>
		<?php if($data['user']['user_id'] != $data[0]['user_view']['user_id']): ?>
  ...
  <section class="toolbar toolbar-profile" data-fixed="true">
    <div class="container">
      <div class="profile-avatar">
        <a href="#"><img src="<?= $images . '/user/avatar.jpg'; ?>" alt=""></a>
        <div class="sticky">
          <a href="#"><img src="<?= $images . '/user/avatar-sm.jpg'; ?>" alt=""></a>
      ...
      <div class="row">
        <div class="col-lg-3 hidden-md-down">
          ...
          <div class="widget widget-about">
            ...
            <p>Description about me and why I am building a social network site for gamers.</p>
            <ul>
              <li><i class="fa fa-clock-o"></i> Joined April 1996</li>
              <li><i class="fa fa-map-marker"></i> Country</li>
              <li><a href="#" target="_blank"><i class="fa fa-chain-broken"></i> Kriekon</a></li>
              <li><a href="#" target="_blank"><i class="fa fa-facebook"></i> Kriekon</a></li>
            </ul>
          </div>
          ...
          <div class="widget widget-friends">
            ...
            <ul>
              <li><a href="#" data-toggle="tooltip" title="Elizabeth"><img src="<?= $images . '/widget/widget-user-1.jpg'; ?>" alt=""></a></li>
              <li><a href="#" data-toggle="tooltip" title="Clark"><img src="<?= $images . '/widget/widget-user-2.jpg'; ?>" alt=""></a></li>
              <li><a href="#" data-toggle="tooltip" title="Trevor"><img src="<?= $images . '/widget/widget-user-3.jpg'; ?>" alt=""></a></li>
              <li><a href="#" data-toggle="tooltip" title="Franklin"><img src="<?= $images . '/widget/widget-user-4.jpg'; ?>" alt=""></a></li>
              <li><a href="#" data-toggle="tooltip" title="John"><img src="<?= $images . '/widget/widget-user-5.jpg'; ?>" alt=""></a></li>
              <li><a href="#" data-toggle="tooltip" title="Bruce"><img src="<?= $images . '/widget/widget-user-6.jpg'; ?>" alt=""></a></li>
              <li><a href="#" data-toggle="tooltip" title="Sherlock"><img src="<?= $images . '/widget/widget-user-7.jpg'; ?>" alt=""></a></li>
              <li><a href="#" data-toggle="tooltip" title="Clara"><img src="<?= $images . '/widget/widget-user-8.jpg'; ?>" alt=""></a></li>
            </ul>
          </div>
          ...
          <div class="widget widget-images">
            ...
            <ul>
              <li><a href="#"><img src="<?= $images . '/widget/widget-images-1.jpg'; ?>" alt=""></a></li>
              <li><a href="#"><img src="<?= $images . '/widget/widget-images-2.jpg'; ?>" alt=""></a></li>
              <li><a href="#"><img src="<?= $images . '/widget/widget-images-3.jpg'; ?>" alt=""></a></li>
              <li><a href="#"><img src="<?= $images . '/widget/widget-images-4.jpg'; ?>" alt=""></a></li>
              <li><a href="#"><img src="<?= $images . '/widget/widget-images-5.jpg'; ?>" alt=""></a></li>
              <li><a href="#"><img src="<?= $images . '/widget/widget-images-6.jpg'; ?>" alt=""></a></li>
            </ul>
